...
parse_args() {
  ...
  readonly INPUT_AWS_S3_BUCKET_NAME INPUT_AWS_S3_KEY INPUT_TARGET_PATH
  export INPUT_AWS_S3_BUCKET_NAME INPUT_AWS_S3_KEY INPUT_TARGET_PATH
}
...
main() {
  ...
  aws_s3_key="${INPUT_AWS_S3_KEY:-$default_aws_s3_key}"
